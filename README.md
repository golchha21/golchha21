...
I build and maintain open-source projects that solve practical problems in real-world web platforms.

### [ReSmushIt for Laravel](https://github.com/golchha21/ReSmushIt)
...
![Last Commit](https://img.shields.io/github/last-commit/golchha21/ReSmushIt?color=666666)

Practical image optimization for Laravel-based platforms, focused on predictable automation and maintainable workflows.
...
![Last Commit](https://img.shields.io/github/last-commit/golchha21/HTMLForge?color=666666)

Structured HTML generation designed to improve clarity, consistency, and long-term maintainability.
